...
const InstructorLogin = () => {
    ...
    const handleLogin = async (e) => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                localStorage.setItem('user_id', data.user_id); // Assuming API returns `user_id`

                if (data.redirect === "/instructor_dashboard") {
        ...
        try {
            ...
            if (response.ok) {
                ...
                if (data.redirect === '/instructor_dashboard') {
                    ...
                    setError('You are not authorized to access the Learner dashboard.');
                }
            } else {
    ...
    const styles = {
        ...
        linkContainer: {
            marginTop: '2rem', // Add extra space before the link
        },
        link: {
            fontSize: '0.9rem',
            textDecoration: 'none',
    ...
    return (
        <div style={styles.container}>
            <h1 style={styles.header}>Instructor Login</h1>
